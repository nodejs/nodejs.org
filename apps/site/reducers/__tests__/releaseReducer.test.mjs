...
describe('releaseReducer', () => {
  it('should return the initial state', () => {
    ...
    assert.deepStrictEqual(reducer(initialState, action), initialState);
  });
  ...
  it('should handle SET_VERSION action', () => {
    ...
    assert.deepStrictEqual(reducer(initialState, action), expectedState);
  });
...
describe('getActions', () => {
  it('should create actions correctly', t => {
    ...
    assert.deepStrictEqual(dispatch.mock.calls.at(-1).arguments, [
      {
        type: 'SET_VERSION',
        payload: 'v14.17.0',
      },

...
> **Remarque :** pour soumettre un rapport via HackerOne, vous devez obtenir un score minimum de
> [Signal](https://docs.hackerone.com/en/articles/8369891-signal-impact) de **1,0**.
> Si votre score Signal est inférieur à ce seuil, veuillez contacter directement les responsables de la sécurité Node.js
> via le
> [Slack de la Fondation OpenJS](https://slack-invite.openjsf.org/).

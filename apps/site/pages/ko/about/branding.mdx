...
로켓 거북이를 디자인하고 기여한 [@Ang_ngl on X](https://x.com/Ang_ngl)에게 감사드립니다.
...
<table>
  <tbody>
    ...
    <tr>
      <td>
        <img
          alt="Node.js 검은색 세로 로고"
          src="/static/logos/nodejsStackedBlack.svg"
        />
      </td>
      <td>
        <img
          alt="Node.js 흰색 세로 로고"

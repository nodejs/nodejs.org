...
> **Nota:** Enviar un reporte a través de HackerOne requiere una puntuación mínima de [Signal](https://docs.hackerone.com/en/articles/8369891-signal-impact) de **1.0**. Si su puntuación de Signal es inferior a este umbral, por favor comuníquese directamente con los responsables de lanzamientos de seguridad de Node.js a través del [Slack de OpenJS Foundation](https://slack-invite.openjsf.org/).

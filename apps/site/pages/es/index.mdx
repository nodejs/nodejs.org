...
<section>
  ...
  <div className="flex gap-4">
    ...
    <div className="flex flex-col gap-2">
      <Button kind="special" className="!hidden dark:!block" href="/download">Obtener Node.js®</Button>

      <Button kind="primary" className="!block dark:!hidden" href="/download">Obtener Node.js®</Button>

      <Button kind="secondary" className="!block" href="/about/eol">
        <span>Obtener soporte de seguridad</span>
        <br />
        <small className="!text-xs">para versiones de Node.js sin soporte (EOL)</small>
      </Button>

      <div className="flex justify-center ml:mt-3">
        <PartnersList sort="weight" />
      </div>
      <span className="text-center text-sm! text-neutral-800 dark:text-neutral-600 text-balance">Node.js se siente orgulloso por tener estos patrocinadores <Link href="/about/partners">y otros</Link>.</span>
    </div>

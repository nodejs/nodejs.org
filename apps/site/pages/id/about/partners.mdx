...
Pendukung adalah individu dan organisasi yang memberikan dukungan finansial bagi proyek Node.js
melalui [OpenCollective](https://opencollective.com/nodejs) dan [GitHub Sponsors](https://github.com/sponsors/nodejs).

...
> **Catatan:** Mengirimkan laporan melalui HackerOne mensyaratkan skor
> [Signal](https://docs.hackerone.com/en/articles/8369891-signal-impact) minimal **1,0**.
> Jika skor Signal Anda berada di bawah ambang batas ini, silakan hubungi langsung
> pengelola rilis keamanan Node.js melalui
> [Slack OpenJS Foundation](https://slack-invite.openjsf.org/).

...
<section>
  ...
  <div className="flex gap-4">
    <div className="flex flex-col gap-2">
      <Button kind="special" className="!hidden dark:!block" href="/download">Dapatkan Node.js®</Button>

      <Button kind="primary" className="!block dark:!hidden" href="/download">Dapatkan Node.js®</Button>

      <Button kind="secondary" className="!block" href="/about/eol">
        <span>Dapatkan dukungan keamanan</span>

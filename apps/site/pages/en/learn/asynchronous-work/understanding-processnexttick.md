...
setImmediate(() => {
  console.log('The immediate running last => number 4');
})

setTimeout(() => {
  console.log('The timeout running before immediate => number 3');
}, 0);
...
The timeout running before immediate => number 3
The immediate running last => number 4
```

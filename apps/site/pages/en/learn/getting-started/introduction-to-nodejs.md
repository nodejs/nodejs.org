...
Node.js runs the V8 JavaScript engine, the core of Google Chrome, outside of the browser.As a result, Node.js allows developers to run JavaScript directly from the terminal or command-line interface (CLI), without needing a browser.

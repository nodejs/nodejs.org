...
Download a signed <Release.DownloadLink kind="source">Node.js source</Release.DownloadLink> tarball
and Learn how to <LinkWithArrow href="https://github.com/nodejs/node/blob/main/BUILDING.md#building-nodejs-on-supported-platforms">build Node.js</LinkWithArrow> from source.

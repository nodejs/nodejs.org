...
- The [Node.js official Discord server](https://discord.gg/vUsrbjd) is a place to chat with other Node.js developers and getting official news from the Node.js project.

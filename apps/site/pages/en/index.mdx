...
<section>
  ...
  <div className="flex gap-4">
    ...
    <div className="flex flex-col gap-2">
      ...
      <span className="italic text-center text-xs! text-gray-500">"LTS" refers to the long-term support version of Node.js. <Link href="/about/previous-releases">Learn more about Node.js releases.</Link></span>
    </div>

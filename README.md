...
This will start the development server on `http://localhost:8080/en/`. This link should reload automatically when you make changes to the code, but no code is perfect, so sometimes you may need to restart it. :)

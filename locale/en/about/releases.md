...
Production applications should only use _Active LTS_ or _Maintenance LTS_ releases. A [list of End-of-Life Releases](Node.js Release Working Group) is maintained by the Node.js Release Working Group.

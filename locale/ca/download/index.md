...
downloads:
    ...
    tagline-lts: Recomennat per a la majoria
...
additional:
    ...
    intro: >
        Membres de la comunitat de Node.js proveén paquets pre-compilats de forma no oficial per a plataformes addicionals no suportades per l'equip central de Node.js que poden no estar al mateix nivell de les versions actuals oficials de Node.js.
    platform: Plataforma
    provider: Proveïdor
---

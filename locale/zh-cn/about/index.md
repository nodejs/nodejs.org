...
如果你对这门语言其中的一部分尚未熟悉理解，这里有一篇专门关于[阻塞对比非阻塞](/zh-cn/docs/guides/blocking-vs-non-blocking/)的文章供你参考。

---

Node.js 在设计上类似于 Ruby 的[事件机](https://github.com/eventmachine/eventmachine)或 Python 的 [Twisted](https://twistedmatrix.com/trac/)之类的系统。Node.js 更深入地考虑事件模型。它呈现一个[事件轮询](/zh-cn/docs/guides/event-loop-timers-and-nexttick/)作为运行时构造而不是库。在其它系统中，总是有一个阻止调用来启动事件循环。

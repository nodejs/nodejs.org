...
Berikut ini adalah contoh sederhana tentang bagaimana handler `'error'` yang hilang memungkinkan
...
Mencoba pembersihan sumber daya yang tepat pada pengecualian tak terduga menjadi lebih kompleks

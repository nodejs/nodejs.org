...
Node.js Foundation відкритий для бізнесу та окремих осіб. Окремі члени обиратимуть у січні двох представників до складу Ради директорів, які будуть відповідати за подання різноманітних потреб спільноти Node.js в управлінні Node.js Foundation.

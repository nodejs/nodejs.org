// Next.js React Intl Translation Manifest
// In order to add new Translations to this application, please add the new locale
// to the `i18n/config.json` file and then add the new locale file to this directory
// and import it below.

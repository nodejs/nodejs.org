...
<div className="my-4 flex items-center justify-center">
  <img alt="Node.js maskotu" src="/static/images/node-mascot.svg" className="w-[100px]" />
</div>

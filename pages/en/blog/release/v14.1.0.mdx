...
* **module**: do not warn when accessing <code>{'__' + 'esModule'}</code> of unfinished exports (Anna Henningsen) [#33048](https://github.com/nodejs/node/pull/33048)
...
* [[`4abc45a4b9`](https://github.com/nodejs/node/commit/4abc45a4b9)] - **module**: do not warn when accessing <code>{'__' + 'esModule'}</code> of unfinished exports (Anna Henningsen) [#33048](https://github.com/nodejs/node/pull/33048)

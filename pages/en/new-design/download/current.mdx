...
<section>
I want the <Release.VersionDropdown status="Current" /> version of Node for <Release.OperatingSystemDropdown exclude={["LINUX"]} /> running <Release.BitnessDropdown />

<Release.DownloadButton />
</section>

<Release.Status /> Version: <Release.Version /> (includes

...
<div className="my-4 flex items-center justify-center">
  <img alt="Mascote Node.js" src="/static/images/node-mascot.svg" className="w-[100px]" />
</div>
...
O Node.js se trata de um runtime Javascript orientado a eventos assíncronos. Dessa forma é modelado para construção escalável de aplicações em rede. No exemplo "hello world" abaixo, várias conexões podem ser suportadas de forma concorrente. A cada conexão, uma callback é disparada, todavia, caso não haja nenhum trabalho a ser feito, o Node.js irá entrar em repouso.

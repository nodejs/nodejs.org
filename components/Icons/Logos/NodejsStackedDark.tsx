...
const NodejsStackedDark: FC<SVGProps<SVGSVGElement>> = props => (
  <svg
    width="289"
    height="177"
    viewBox="0 0 289 177"
  ...
  >
    <g clipPath="url(#clip0_337_7900)">
      <mask
        ...
        height="177"
      >
        <path d="M289 0H0v177h289V0Z" fill="#fff" />
      </mask>
      <g mask="url(#mask0_337_7900)">
        ...
        />
        <path
          d="M135.877 56.779 108.244 40.9a4.543 4.543 0 0 0-.849-.326L76.5 93.5c.261.327.673.804 1 1l27.478 15.725c.784.457 1.698.588 2.548.326l29.069-53.184a2.044 2.044 0 0 0-.718-.588Z"
          fill="url(#paint1_linear_337_7900)"
        />
        <path
          d="m104.063 35.086-.392.196h.523l-.131-.196Z"
    ...
    <defs>
      ...
      <clipPath id="clip0_337_7900">
        <path fill="#fff" d="M0 0h289v177H0z" />
      </clipPath>
    </defs>
  </svg>
);

export default NodejsStackedDark;
